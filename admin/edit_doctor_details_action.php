...
// Check if the form is submitted
	...
	if (move_uploaded_file($picture_tmp_name, $target_file)) {
      ...
      $sql = "UPDATE doctor_details SET doctor_name='$doctor_name', graduation_status='$doctor_graduation', email_id='$doctor_email', specialist='$doctor_specialist', fees='$doctor_fees', gender='$doctor_gender', address='$doctor_address', mobile='$doctor_mobile', status='$status', experience='$doctor_experience', profile_photo='$target_file', update_at='$currentTimestamp' WHERE doctor_id='$id'";
